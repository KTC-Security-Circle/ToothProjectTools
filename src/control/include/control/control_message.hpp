...
struct ControlResponse
{
    ...
    static ControlResponse success(std::optional<std::string> id, ControlFields fields = {});
    ...
    static ControlResponse failure(std::optional<std::string> id, std::string code, std::string message);
};
